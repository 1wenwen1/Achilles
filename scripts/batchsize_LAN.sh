...
echo "------LAN--------" > /root/damysus_updated/stats.txt
...
do
    ...
    python run.py --p1 --batchsize $b --payload 256 --faults 10
    python close.py
    sleep 5
    python run.py --p2 --batchsize $b --payload 256 --faults 10
    python close.py
    sleep 5
    python run.py --p3 --batchsize $b --payload 256 --faults 10
    python close.py
    sleep 5
done