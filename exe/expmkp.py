...
parser.add_argument("--p",    type=int, default=0,   help="protocol")
...
if args.test:
    ...
    PRO = Protocol.CHCOMB
    runChComb = True
    if (args.p >= 1 and args.p <= 3) or args.p == 8:
        const_factor = 3
    if args.p == 8:
        PRO = Protocol.CHBASE
        runChComb = False
    ...
    if args.p == 0:
        os.system("bash setup_achillies.sh")
    elif args.p <= 3:
        os.system("bash setup_flex.sh")
    elif args.p <= 7:
